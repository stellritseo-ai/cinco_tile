...
export function TranslationProvider({ children }: { children: ReactNode }) {
  ...
  useEffect(() => {
    const savedLanguage = localStorage.getItem("cinco-language") as Language;
  ...
  const setLanguage = (lang: Language) => {
    ...
    localStorage.setItem("cinco-language", lang);
  };
...
export const translations = {
  en: {
    ...
    "hero.description": "Cinco Tile Landscaping Design is a Concrete Contractor in San Antonio, TX.\nWe offer Landscaping, Outdoor Kitchen Design, Hardscaping and more!",
    "hero.btn.consultation": "Get Your Free Consultation",
    "hero.btn.book": "Book A Service",

    // Welcome Section
    "welcome.badge": "Cinco Tile CONSTRUCTION LANDSCAPING DESIGN",
    ...
    "welcome.desc": "Welcome to Cinco Tile Landscaping Design, your trusted partner for premier remodeling and outdoor living in San Antonio. For over three and a half decades, principal & design consultant Robert Thompson and our skilled team have been dedicated to turning our clients' visions into stunning, lasting reality. We combine unparalleled craftsmanship with creative design to enhance both the beauty and value of your property.",
    ...
    "freeconsult.desc": "Take the first step toward your dream space. Get a detailed, free quote from Cinco Tile. From house remodeling to custom hardscapes, we provide the clarity and expert planning you need to move forward with confidence.",
    ...
    "reviews.1.text": "Cinco Tile did an absolutely incredible job on our outdoor kitchen. The craftsmanship is top-notch and they finished on time and on budget. Couldn't be happier!",
    ...
    "reviews.3.text": "We hired Cinco Tile for a complete house remodel and the results exceeded our expectations. They communicate well and stand behind their work. Truly the best in San Antonio.",
    ...
    // FAQ Section
    "faq.badge": "FAQ'S",
    "faq.title": "Got Questions? Cinco Tile Has Answers.",
    ...
    "faq.a2": "Absolutely. Cinco Tile is a fully licensed, insured, and bonded contractor in the state of Texas. This is a non-negotiable part of our business and your protection. We will provide proof of insurance upon request before any project begins, ensuring complete peace of mind for our residential and commercial clients.",
    ...
    "cta.desc": "Contact Cinco Tile for a free, no-obligation estimate. We're here to discuss your project and provide the expert guidance you need.",
    ...
    // Footer Section
    "footer.desc": "Cinco Tile Landscaping Design, your trusted partner for premier remodeling and outdoor living in San Antonio. For over three and a half decades, principal & design consultant Robert Thompson and our skilled team have been dedicated to turning our clients' visions into stunning, lasting reality. We combine unparalleled craftsmanship with creative design to enhance both the beauty and value of your property.",
    "footer.title.col1": "Cinco Tile Landscaping Design",
    ...
    "footer.copyright": "Copyright © 2025 Cinco Tile Landscaping Design. All rights reserved.",
  },
  es: {
    // TopBar & Header
    "topbar.email": "robertsa210@icloud.com",
    ...
    // Welcome Section
    "welcome.badge": "DISEÑO DE CONSTRUCCIÓN Y PAISAJISMO Cinco Tile",
    ...
    "getstarted.description": "Durante más de tres décadas, Cinco Tile ha sido el nombre de confianza en San Antonio para transformar propiedades, restaurar su belleza y renovarlas en algo extraordinario. Ya sea que se esté recuperando de un daño inesperado o listo para actualizar y mejorar su espacio, el consultor principal y de diseño Robert Thompson y nuestro equipo de expertos aportan 35 años de precisión, cuidado y artesanía a cada proyecto.",
    "getstarted.btn.consultation": "Obtenga su consulta gratuita",
    "getstarted.btn.gallery": "Ver nuestra galería",

    // Why Choose Section
    "whychoose.badge": "POR QUÉ ELEGIR Cinco Tile CONSTRUCTION LANDSCAPING DESIGN",
    "whychoose.title": "Por qué los propietarios y empresas de San Antonio confían en Cinco Tile",
    "whychoose.desc1": "Durante 35 años, Robert Thompson y el equipo de Cinco Tile han construido una reputación de confiabilidad y calidad inigualables.",
    ...
    "freeconsult.desc": "Dé el primer paso hacia el espacio de sus sueños. Obtenga una cotización detallada y gratuita de Cinco Tile. Desde remodelación de casas hasta hardscapes personalizados, le brindamos la claridad y la planificación experta que necesita para avanzar con confianza.",
    ...
    "reviews.1.text": "Cinco Tile hizo un trabajo absolutamente increíble en nuestra cocina al aire libre. La artesanía es de primera y terminaron a tiempo y dentro del presupuesto. ¡No podría estar más feliz!",
    ...
    "reviews.3.text": "Contratamos a Cinco Tile para una remodelación completa de la casa y los resultados superaron nuestras expectativas. Se comunican bien y respaldan su trabajo. Verdaderamente los mejores en San Antonio.",
    ...
    "faq.title": "¿Tiene Preguntas? Cinco Tile Tiene Respuestas.",
    ...
    "cta.desc": "Póngase en contacto con Cinco Tile para obtener un presupuesto gratuito y sin compromiso. Estamos aquí para discutir su proyecto y brindarle la orientación experta que necesita.",
    ...
    // Footer Section
    "footer.desc": "Cinco Tile Landscaping Design, su socio de confianza para remodelación y vida al aire libre de primer nivel en San Antonio. Durante más de tres décadas y media, el consultor principal y de diseño Robert Thompson y nuestro capacitado equipo se han dedicado a convertir las visiones de nuestros clientes en una realidad impresionante y duradera. Combinamos una artesanía inigualable con un diseño creativo para mejorar tanto la belleza como el valor de su propiedad.",
    "footer.title.col1": "Cinco Tile Landscaping Design",
    ...
    "footer.copyright": "Derechos de autor © 2025 Cinco Tile Landscaping Design. Todos los derechos reservados.",
  }
};
