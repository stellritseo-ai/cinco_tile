...
const bathroomImg = residentialHero;
const kitchenImg = residentialHero;
const tileImg = residentialHero;
const transformImg = residentialHero;
const estimateImg = residentialHero;
const showroomImg = residentialHero;
