      ...
      <div className="relative max-w-7xl mx-auto px-4 sm:px-6 w-full pt-10">
        <div className="max-w-5xl text-white mx-auto text-center">
          ...
          <div className="mt-[20px] sm:mt-[25px] flex flex-col sm:flex-row flex-wrap justify-center gap-3 sm:gap-4 px-4 sm:px-0">
            <button
              onClick={openModal}
              className="inline-flex items-center justify-center gap-2.5 bg-[#d62828] text-white rounded-full px-7 py-3 text-[15px] font-bold hover:brightness-110 transition-all shadow-[0_4px_14px_0_rgba(214,40,40,0.39)] cursor-pointer border-none outline-none"
            >
