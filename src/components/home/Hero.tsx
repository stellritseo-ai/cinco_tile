...
export const Hero = () => (
  <section className="relative min-h-[100vh] flex items-center overflow-hidden">
    ...
    <div className="relative max-w-7xl mx-auto px-6 w-full pt-10">
      <div className="max-w-3xl text-white mx-auto md:mx-0 text-center md:text-left">
        <h1 className="font-sans text-[35px] md:text-[45px] mt-[150px] md:mt-[219px] font-bold leading-[45px] md:leading-[60px] tracking-tight">
          15+ Years of Precision Tile & Flooring <br className="hidden md:inline" /> <span className="text-[#d62828] font-black">Installation in Houston</span>
        </h1>
        <p className="mt-[10px] text-[16px] md:text-[18px] text-white/90 max-w-[700px] leading-[28px] md:leading-[33px] font-medium mx-auto md:mx-0">
        ...
        <div className="mt-[25px] flex flex-wrap justify-center md:justify-start gap-4">
        ...
        <div className="mt-16 flex flex-row items-center justify-start md:justify-start gap-4 sm:gap-6 md:gap-12 max-w-full overflow-x-auto no-scrollbar py-2 shrink-0">
          {[
