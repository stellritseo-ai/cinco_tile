        ...
        <div className="max-w-[1400px] mx-auto px-6">
          <div className="flex items-center justify-between">
            <a href="#" className="flex items-center">
              <img src={logoImg} alt="Cinco Tile Logo" className="h-[55px] md:h-[70px] w-auto object-contain transition-transform duration-300 hover:scale-105" />
            </a>
      ...
      >
        ...
        >
          ...
          <div className="flex items-center justify-between pb-5 border-b border-white/10 mt-14">
            <img src={logoImg} alt="Cinco Tile Logo" className="h-[40px] w-auto object-contain" />
            <button 
              onClick={() => setIsOpen(false)} 
