      ...
      <div className="max-w-[1440px] mx-auto px-4 sm:px-6 lg:px-12 relative z-10">
        ...
        <Reveal variant="reveal">
          <div className="text-center max-w-[800px] mx-auto relative z-20">
            ...
            <h2 className="mt-[24px] font-sans text-[22px] sm:text-[28px] md:text-[35px] font-extrabold text-[#111827] leading-[1.2] tracking-tight">
        ...
        {/* Benefits Grid */}
        <div className="mt-[48px] sm:mt-[80px] grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-[32px] lg:gap-[60px] max-w-[1200px] mx-auto">
          {/* Benefit 1 */}
          <Reveal variant="reveal" className="stagger-1 text-center flex flex-col items-center">
          ...
          {/* Benefit 2 */}
          <Reveal variant="reveal" className="stagger-2 text-center flex flex-col items-center">
          ...
          {/* Benefit 3 */}
          <Reveal variant="reveal" className="stagger-3 text-center flex flex-col items-center">
