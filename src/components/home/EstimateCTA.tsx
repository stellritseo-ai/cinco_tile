          ...
          <div className="relative rounded-[16px] overflow-hidden shadow-2xl bg-[#111827]">
            ...
            <div className="relative z-10 py-[60px] sm:py-[80px] px-4 sm:px-6 max-w-[800px] mx-auto text-center flex flex-col items-center">
              ...
              <div className="mt-[32px] flex flex-col sm:flex-row items-center gap-[32px]">
                <button
                  onClick={openModal}
                  className="inline-flex items-center justify-center gap-[10px] bg-[#d62828] text-white font-bold text-[16px] h-[48px] px-[24px] rounded-[6px] hover:bg-[#b52020] hover:scale-[1.03] active:scale-[0.97] transition-all duration-300 shadow-[0_4px_14px_0_rgba(214,40,40,0.3)] cursor-pointer border-none outline-none"
                >
